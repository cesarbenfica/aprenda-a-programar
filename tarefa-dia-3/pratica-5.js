...
let totalValor1 = receita.reduce( (prevVal, elem) => prevVal + elem.valor, 0)
console.log(`O valor total das vendas sem gorjeta é de ${totalValor1} reais`)
...
let totalValor2 = receita.reduce( (prevVal, elem1) => prevVal + elem1.valor, 0)
let totalGorjetas = receita.reduce( (prevGorj, elem2) => prevGorj + elem2.gorjeta, 0)
let totalGeral = totalValor2 + totalGorjetas
console.log(`O valor total das vendas incluindo as gorjetas é de ${totalGeral} reais`)
...
let vendasMenores = receita.filter( (vendasMenor, index, array) => vendasMenor.valor < 50)
quantVendasMenores = vendasMenores.length
console.log(`Há um total de ${quantVendasMenores} vendas abaixo de R$50,00`)
